...
#
# This spec file is for version 3.0.0 of libxc; the appropriate
...
%configure \
  ...
  FCFLAGS="" \
  CFLAGS="-g -O2" \
  CPPFLAGS=" -I/home/ceresoli/Julia-Work/Pkg/LibXC/deps/usr/include" \
  LDFLAGS=" -L/home/ceresoli/Julia-Work/Pkg/LibXC/deps/usr/lib -Wl,-rpath -Wl,/home/ceresoli/Julia-Work/Pkg/LibXC/deps/usr/lib" \
  --disable-static
